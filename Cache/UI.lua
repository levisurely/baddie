...
function UI:CreateClose(Frame, Index)
	...
	CC.BackgroundColor3 = Color3.new(1, 0, 0);
	CC.BackgroundTransparency = 0;
	CC.ZIndex = Index + 2;
	CC.Size = UDim2.new(0, 0, 0, 0);
	CC.Position = UDim2.new(0, 0, 0, 0);
	CC.Parent = Frame;
	return CC;
end;
function UI:CreateTitle(Frame, Text)
	...
	jackTitle.Size = UDim2.new(0, 0, 0, 0);
...
function UI:CreateScroll(Frame, Index)
	...
	GameUI.Size = UDim2.new(1, 0, 0, 0);
	GameUI.Position = UDim2.new(0, 0, 0, 0);
	GameUI.Visible = true;
	GameUI.AutomaticCanvasSize = Enum.AutomaticSize.Y;
	GameUI.Parent = Frame;
	local GameGrid = Instance.new("UIGridLayout");
	GameGrid.CellSize = UDim2.new(0, 0, 0, 0);
...
local THEMEButton1 = UI:CreateButton(UIUI, "Theme: Dark", Color3.new(0, 0, 1));
local CButton1 = UI:CreateButton(jackUI, "Character Settings", Color3.new(1, 0, 0));
local CButton2 = UI:CreateButton(jackUI, "UI Settings", Color3.new(0, 0, 1));
...
THEMEButton1.MouseButton1Down:Connect(function()
	if CXolor == Color3.new(0, 0, 0) then
		CXolor = Color3.new(0, 0, 0);
